    ...
    <div className='bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-4 font-[Poppins]'>
      <div className='max-w-7xl mx-auto'>
        <div className='text-center mb-14'>
          <h1 className='text-5xl font-bold mb-4 transform transition-all bg-gradient-to-r from-amber-400 to-amber-600
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2'>
          {displayList.map(item => {
            ...
            return (
              ...
              shadow-2xl overflow-hidden transform hover:translate-y-1 transition-all duration-500
              ...
              before:inset-0 hover:before:opacity-20'>
                ...
                <div className='p-6 relative z-10'>
                  ...
                  <p className='text-gray-100 mb-5 text-sm leading-relaxed tracking-wider'>
                    {item.description}
                  </p>
