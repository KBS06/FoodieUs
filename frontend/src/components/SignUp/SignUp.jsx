...
import { FaCheckCircle, FaEyeSlash, FaEye, FaArrowRight, FaArrowLeft, FaExclamationCircle } from 'react-icons/fa';
...
const SignUp = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    console.log('Submitting sign up form with:', formData)
    try{
      ...
      setShowToast({visible: false, message: msg, icon: <FaExclamationCircle/>})
    }
  }
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-[1a120b] p-4'>
      ...
      <div className='w-full max-w-md bg-gradient-to-br from-[#2D1B0E] to-[#4a372a] p-8 rounded-xl 
      border-4 border-amber-700/30 transform transition-all duration-300 hover:shadow-amber-2xl'>
