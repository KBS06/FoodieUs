      ...
      xl:gap-16 relative '>
        <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 px-4 sm:px-0'>
            {aboutfeature.map((item, i) => (
              ...
              duration-300 p-4 sm:p-5 hover:translate-x-2'>
                <div className={`p-3 sm:p-4 rounded-full bg-gradient-to-br ${item.color} transition-transform 
          ...
          <div className='flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0'>
            ...
            rounded-xl font-bold hover:scale-[1.02] transition-transform duration-300 flex items-center gap-2 sm:gap-3 shadow-xl 
        ...
        group transform hover:scale-[1.01] transition-all duration-500'> 
          ...
          duration-500 shadow-2xl shadow-black/50 '>
            <div className='absolute inset-0 bg-gradient-to-br from-amber-400/50 via-transparent to-amber-600/10 mix-blend-soft-light'/>
