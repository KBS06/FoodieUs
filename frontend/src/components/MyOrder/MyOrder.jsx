  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#1a120b]">
        <div className="text-amber-300 text-lg animate-pulse">Loading your orders...</div>
      </div>
    );
  }
  ...
  return (
    ...
    sm:px-6 lg:px-8 '>
      <div className='mx-auto max-w-7xl'>
        ...
        <div className='bg-[#4b3b3b]/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border-2
        border-amber-500/20'>
          <h2 className='text-3xl font-bold mb-8 bg-gradient-to-r from-amber-300 to-amber-500
                      ...
                      border text-sm`}>
                        ...
                        <td className='p-4'>
                          <div className='flex items-center gap-2'>
                            ...
                            <span className={`px-4 py-2 rounded-lg ${status.bg} ${status.color} border
                      border-amber-500/20 text-sm`}>
                              {status.label}
                            </span>
                          </div>
                        </td>
