...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert((`Thanks for subscribing! We'll send updates ${email}`));
    setEmail('');
  }

  return (
    <footer className='bg-[#2A211C] text-amber-100 py-12 px-4 sm:px-6 lg:px-8 
    relative overflow-hidden'>
      <div className='max-w-7xl mx-auto relative z-10'>
          ...
          <div className='space-y-6'>
            ...
            <form onSubmit={handleSubmit} className='relative mt-8 group '>
              ...
              <div className='relative'>
                ...
                className='w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-amber-400/30 focus:outline-none
                ...
                via-amber-500 to-amber-600 text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30
                overflow-hidden transition-all duration-500'>
                  <span className='font-bold text-sm transition-transform duration-300 
          ...
          <div className='flex justify-center md:justify-end'>
            <div className='space-y-4'>
              ...
              <div className='flex space-x-4'>
                {socialIcons.map(({icon: IconBase, link, color, label}, idx ) => (
                  ...
                  transition-all duration-300 relative group'
                    style={{color}}>
                      <IconBase className='hover:scale-125 transition-transform'/>
        ...
        {/*BOTTOM SECTION  */}
        <div className='border-amber-800 border-t pt-8 mt-8 text-center '>
          <p className='text-amber-400 text-lg mb-2 font-playfair'>
            &copy; 2025 FoodieUs. All Rights Reserved.
          </p>
