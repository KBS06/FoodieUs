...
const About = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b]
    text-amber-50 overflow-hidden relative'>
      ...
      {/**Hero Section */}
                ...
                transition={{delay: i* 0.2}} className='relative group'>
                  ...
                  border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full'>
                    <div className='relative h-64 overflow-hidden'>
                      <motion.img src={f.img} alt={f.title}
                    ...
                    <div className='p-8 '>
                      ...
                      <p className='text-amber-100/30'>{f.text}</p>
                    </div>
                  </div>
                </motion.div>
              )
            ...
            {stats.map((s,i) => {
              ...
              return (
                ...
                animate={{
                    ...
                    border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300'>
                      ...
                      <div className='relative z-10 h-full flex flex-col items-center justify-center'>
                        ...
                        whileHover={{scale:1.1, rotate:10 }}>
                          <Icon className='w-8 h-8 text-amber-900/90'/>
                        </motion.div>
                        ...
                        animate={{letterSpacing: hoveredStat === i ? '0.15em' : '0.1em',
                  ...
                  animate={{opacity: hoveredStat === i ? 0.4 : 0.2,
        ...
        <section className='py-16 px-4 md:px-8 relative'>
            <div className='max-w-7xl mx-auto'>
              ...
              whileInView={{opacity:1 , y:0}}
              className='text-4xl font-serif sm:text-5xl md:text-6xl font-bold text-center mb-12 
              text-amber-100 '>
                  ...
                  >
                    ...
                    shadow hover:shadow-2xl hover:shadow-amber-500/20 '>
                      <div className='relative h-64 sm:h-72 md:h-96 overflow-hidden'>
                        ...
                        className='w-full h-full object-cover' initial={{scale:1}} 
                      ...
                      <div className='p-8 text-center flex flex-col h-[calc(100%-24rem)]'>
                        ...
                        <p className='text-amber-100/80 text-lg font-cursive flex-glow'>
                          {m.bio}
                        </p>
