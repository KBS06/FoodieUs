...
const OurMenu = () => {
  ...
  useEffect(() => {
    const fetchMenu = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/items`);
  ...
  return (
    <div className='bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] min-h-screen py-16 px-4
    sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        <h2 className='text-center mb-12 bg-clip-text text-transparent
        bg-amber-200 via-amber-300 to-amber-200'>
            ...
            return (
              ...
              border-amber-800/30 backdrop-blur-sm flex flex-col transition-all duration-500'
                ...
                <div className='p-4 sm:p-6 flex flex-col flex-grow'>
                  ...
                  <div className='mt-auto flex items-center gap-1 justify-between '>
                    <div className='bg-amber-100/10 backdrop-blur-sm px-1.5 py-1 rounded-2xl shadow-lg '>
                      ...
                      {quantity > 0 ? (
                        <>
                          ...
                          justify-center hover:bg-amber-800/50 transition-colors'
                            onClick={() => quantity > 1 ? updateQuantity(cartEntry._id, quantity - 1) :
                        ...
                        border border-amber-800/50 '>
                          <span className='relative z-10 text-xs text-amber-200/80'>
                            Add to Cart
                          </span>
                        </button>
                      )}
