...
const CartPage = () => {
  ...
  return (
    ...
    from-[#1a120b] via-[#2a1e14] to-[#3e2b1d]'>
      <div className='max-w-7xl mx-auto'>
        ...
        {cartItems.length === 0 ? (
          <div className='text-center animate-fade-in'>
            ...
            <Link to='/menu' className='bg-amber-900/40 px-6 py-2 rounded-full font-cinzel text-sm uppercase
            hover:bg-amber-800/50 transition-all duration-300 text-amber-100 inline-flex items-center gap-2 hover:gap-3'>
              Browse All Items
            </Link>
          </div>
        ) : (
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
            {cartItems.map(({_id, item, quantity}) => (
              ...
              hover:border-solid hover:shadow-xl hover:shadow-amber-900/10 transform 
          ...
          <div className='mt-12 pt-8 border-amber-800/30 animate-fade-in-up'>
              <div className='flex flex-col sm:flex-row justify-between items-center gap-4'>
                <Link to='/menu' className='bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase tracking-wider
                ...
                <div className='flex items-center gap-8'>
                  <h2 className='text-3 font-dancingscript text-amber-100'>
                    Total: ₹{Number(totalAmount).toFixed(2)}
                  </h2>

                  <Link to='/checkout' className='bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase tracking-wider
      ...
      {selectedImage && (
        ...
        onClick={() => setSelectedImage(null)}>
          <div className='relative max-w-full max-h-full'>
            ...
            className='absolute top-1 right-1 bg-amber-900/80 rounded-full p-2 text-black hover:bg-amber-800/90
