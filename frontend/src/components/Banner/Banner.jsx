...
const Banner = () => {
  ...
  return (
    <div className='relative'>
      ...
      py-16 px-4 sm:px-8 overflow-hidden'>
          ...
          <div className='flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left'>
            ...
            <form onSubmit={handleSearch} className='relative max-w-2xl mx-auto md:mx-0 group'>
              ...
              shadow-2xl hover:bg-amber-400/50 transition-all duration-300'>
                ...
                className='w-full py-4 pr-6 bg-transparent outline-none placeholder-amber-200/70 text-lg font-medium 
                tracking-wide'/>
                <button className='mr-4 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300 rounded-lg
                font-semibold text-amber-900 hover:from-amber-300 hover:to-amber-200 transition-all 
                duration-300 shadow-lg hover:shadow-300/20'>
                  Search
                </button> 
              </div>
            </form>
            ...
            <div className='flex flex-wrap gap-4 justify-center md:justify-start mt-6'>
              <button className='group flex items-center gap-3 bg-amber-800/30 hover:bg-amber-800/50 px-6 py-3 
